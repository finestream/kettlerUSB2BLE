...
Bridge your classic Kettler exercise bike to modern Bluetooth-enabled fitness apps (Zwift, MyWhoosh, etc.) via FTMS (Fitness Machine Service) and Cycling Power Service.
